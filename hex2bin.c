...
int bin2hex(unsigned char *bin, char *hex, int len) {
	int i;	
	for(i = 0; i < len; i++) {
...
int hex2bin(char *hex, unsigned char *bin, int iLen, int *oLen) {
	int bLen;
	int i;
...
int main(int argc, char **argv) {
	...
	int len;
	char *in = "0x0123456789abcdef0a1b2c3d4e5f6a7b8c9daebf";
	char hout[1024];
